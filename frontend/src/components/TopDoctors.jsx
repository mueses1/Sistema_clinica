...
const TopDoctors = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 my-16 text-[#262626] md:mx-10'>
      <h1 className='text-3xl font-medium'>Mejores Doctores para Reservar</h1>
      <p className='sm:w-1/3 text-center text-sm'>Simplemente navega a través de nuestra extensa lista de doctores de confianza.</p>
      ...
      <button onClick={() => { navigate('/doctors'); scrollTo(0, 0) }} className='bg-[#EAEFFF] text-gray-600 px-12 py-3 rounded-full mt-10'>más</button>
    </div>
